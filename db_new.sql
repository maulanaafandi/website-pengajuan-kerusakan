...
--
-- Host: localhost:3306
-- Generation Time: Jun 16, 2026 at 05:22 AM
...
CREATE TABLE `inventaris` (
  ...
  `NUP` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `kategori` enum('Alat','Habis Pakai') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Alat',
...
(1, 1, '3030205014', '1', 'Crimping Tolls', 'DIGILINK', 'DIGILINK', 'Alat', '2021-12-31', '2012-12-12'),
...
CREATE TABLE `laporan` (
  ...
  `kategori` enum('kerusakan','kehilangan') COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `prioritas` enum('Penting dan Mendesak','Penting tapi Tidak Mendesak','Tidak Penting tapi Mendesak','Tidak Penting dan Tidak Mendesak') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `keterangan` text COLLATE utf8mb4_general_ci,
  `selesai_pada` datetime DEFAULT NULL,
  `rekomendasi_ai` tinyint(1) DEFAULT NULL,
  `kode_laporan` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `laporan` (`id`, `id_pelapor`, `id_inventaris`, `id_teknisi`, `waktu_lapor`, `kategori`, `deskripsi`, `bukti_foto`, `kondisi`, `status`, `prioritas`, `keterangan`, `selesai_pada`, `rekomendasi_ai`, `kode_laporan`) VALUES
(1, 3, 1, NULL, '2026-06-16 02:51:40', 'kerusakan', 'Alat scanner rusak', '1781553100349-723792272.jpg', 10.00, 'pending', NULL, NULL, NULL, NULL, 'INV-LAP-20260616-025140-X71I'),
(2, 3, 1, NULL, '2026-06-16 02:54:21', 'kerusakan', 'Alat scanner rusak', '1781553261328-641910514.jpg', 10.00, 'pending', NULL, NULL, NULL, NULL, 'INV-LAP-20260616-025421-POIY'),
(3, 3, 1, NULL, '2026-06-16 02:54:33', 'kerusakan', 'Alat scanner rusak', '1781553273815-321875333.jpg', 10.00, 'pending', NULL, NULL, NULL, NULL, 'INV-LAP-20260616-025433-152Y'),
(4, 3, 1, NULL, '2026-06-16 02:55:07', 'kerusakan', 'Alat scanner rusak', '1781553307105-80980348.jpg', 10.00, 'pending', NULL, NULL, NULL, NULL, 'INV-LAP-20260616-025507-4X7C'),
(5, 3, 2, NULL, '2026-06-16 02:55:14', 'kerusakan', 'Alat scanner rusak', '1781553314147-212219289.jpg', 10.00, 'pending', NULL, NULL, NULL, NULL, 'INV-LAP-20260616-025514-B51L'),
(6, 3, 2, NULL, '2026-06-16 02:55:29', 'kerusakan', 'Alat scanner rusak', '1781553329010-756024727.jpg', 10.00, 'pending', NULL, NULL, NULL, NULL, '20260616-025528-9ILG'),
(7, 3, 2, NULL, '2026-06-16 12:18:10', 'kerusakan', 'Alat scanner rusak', '1781587090345-627046235.jpg', 10.00, NULL, NULL, NULL, NULL, NULL, '20260616-121810-P736');
...
CREATE TABLE `ruangan` (
  `id` int NOT NULL,
  `nama` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `kode_ruangan` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('mahasiswa','dosen','satpam','tendik','plp','admin') COLLATE utf8mb4_general_ci NOT NULL,
  `kaleb` enum('0','1') COLLATE utf8mb4_general_ci DEFAULT '0',
  `status` enum('proses','aktif','nonaktif') COLLATE utf8mb4_general_ci DEFAULT 'proses'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 'qii', 'dosendua@pens.ac.id', '$2b$10$vmQIklI8X/2p5WTeGfnMbOiTMfcCeLAXyMbSFOlbUZ8pjBSPB7rnC', 'plp', '0', 'aktif');
