...
router.patch('/admin/inventaris/edit/:id', authAdmin, AdminController.updateInventaris)
router.delete('/admin/inventaris/delete/:id', authAdmin, AdminController.deleteInventaris)
...
router.patch('/admin/ruangan/edit/:id', authAdmin, AdminController.updateRuangan)
router.delete('/admin/ruangan/delete/:id', authAdmin, AdminController.deleteRuangan)
...
router.patch('/admin/laporan/keterangan/:id', authAdmin, AdminController.updateKeteranganAdmin)
router.patch('/admin/laporan/status/:id', authAdmin, AdminController.updateStatusLaporan)
...
router.patch('/admin/rekomendasi/edit/:id', authAdmin, AdminController.updateRekomendasi)
router.delete('/admin/rekomendasi/delete/:id', authAdmin, AdminController.deleteRekomendasi)
