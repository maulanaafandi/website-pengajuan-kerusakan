...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2026 at 03:37 AM
...
CREATE TABLE `laporan` (
  ...
  `kategori` enum('kerusakan','kehilangan','barang_baru') NOT NULL,
  `deskripsi` text DEFAULT NULL,
  `bukti_foto` varchar(255) DEFAULT NULL,
  `tingkat_kerusakan` enum('ringan','sedang','berat','rusak_total') DEFAULT NULL,
  `status` enum('diproses_internal','diproses_eksternal','ditolak','selesai','diajukan') DEFAULT NULL,
  ...
  `waktu_lapor_semester` varchar(255) DEFAULT NULL,
